package com.bengshiwei.zzj.app.bean.base;
...
//    }
    ...
    public static <M> ResponseModel<M> buildSendMessageFails(M result) {
        return new ResponseModel<M>(FAILS, "发送消息失败",result);
    }
    public static <M> ResponseModel<M> buildFails(M result) {
        return new ResponseModel<M>(FAILS, "数据保存失败",result);
    }
