...
import com.bengshiwei.zzj.app.bean.api.message.MessageCreateModel;
...
public class ChatMessage implements Serializable {
    ...
    // 普通朋友的发送的构造函数
    public ChatMessage(User sender, User receiver, MessageCreateModel model) {
        this.id = model.getId();
    ...
    // 发送给群的构造函数
    public ChatMessage(User sender, Group group, MessageCreateModel model) {
        this.id = model.getId();
        this.content = model.getContent();
        this.attach = model.getAttach();
        this.type = model.getType();
